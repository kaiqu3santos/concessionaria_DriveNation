...
# Form implementation generated from reading ui file 'registrar_venda_tela.ui'
#
...
class Ui_MainWindow(object):
    ...
    def f_registrar_venda(self):
        placa = self.lineEdit_8.text()
        cpf_func = self.lineEdit_4.text()
        cpf_cliente = self.lineEdit_5.text()
        valor = self.lineEdit.text()
        forma_de_pagamento = self.lineEdit_2.text()
        valor_entrada = self.lineEdit_3.text()
        tempo_parcela = self.lineEdit_6.text()
    ...
    def setupUi(self, MainWindow):
        ...
        self.lineEdit.setGeometry(QtCore.QRect(70, 220, 281, 31))
        font = QtGui.QFont()
        ...
        self.lineEdit_2.setGeometry(QtCore.QRect(70, 260, 281, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.lineEdit_4.setGeometry(QtCore.QRect(70, 140, 281, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.lineEdit_3.setGeometry(QtCore.QRect(70, 300, 281, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.lineEdit_8.setGeometry(QtCore.QRect(70, 100, 281, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.lineEdit_5.setGeometry(QtCore.QRect(70, 180, 281, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButton_18.setGeometry(QtCore.QRect(160, 400, 93, 28))
...
"")
        ...
        self.lineEdit_6.setGeometry(QtCore.QRect(70, 340, 281, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_10.setText(_translate("MainWindow", "REGISTRAR VENDA"))
...
"DriveNation"))
        ...
        self.pushButton_18.setText(_translate("MainWindow", "REGISTRAR"))
        self.lineEdit_6.setText(_translate("MainWindow", "TEMPO DE PARCELA"))
        self.pushButton_17.clicked.connect(lambda:self.MainWindow.close())
        self.pushButton_18.clicked.connect(lambda:self.f_registrar_venda())
